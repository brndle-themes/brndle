...
<section class="relative py-24 md:py-32 overflow-hidden text-white noise" style="background-color: {{ ($a['variant'] ?? 'dark') === 'dark' ? 'var(--color-surface-inverse, #080B16)' : 'var(--color-accent, #6366f1)' }}">
