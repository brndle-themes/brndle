...
<html @php(language_attributes()) class="scroll-smooth" data-theme="light">
  <head>
    ...
    <style>
      body { font-family: 'DM Sans', sans-serif; background: #0a0a0a; color: #f5f5f5; }
      h1, h2, h3, h4, nav { font-family: 'Space Grotesk', sans-serif; }

      /* Gradient text */
      .vp-gradient { background: linear-gradient(135deg, #00ff88, #00cc88, #60a5fa); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }

      /* Cursor blink */
      @keyframes blink { 0%,50%{opacity:1} 51%,100%{opacity:0} }
      .vp-cursor { animation: blink 1s infinite; color: #00ff88; }

      /* Mesh bg */
      .vp-mesh { position:absolute;inset:0;overflow:hidden;pointer-events:none }
      .vp-mesh::before { content:'';position:absolute;width:700px;height:700px;border-radius:50%;background:radial-gradient(circle,rgba(0,255,136,0.07) 0%,transparent 70%);top:-300px;right:-200px }
      .vp-mesh::after { content:'';position:absolute;width:500px;height:500px;border-radius:50%;background:radial-gradient(circle,rgba(96,165,250,0.05) 0%,transparent 70%);bottom:-200px;left:-150px }

      /* Section divider */
      .vp-divider { height:1px;background:linear-gradient(90deg,transparent,rgba(0,255,136,0.25),transparent) }
      ...
      /* Buttons */
      .btn-green { display:inline-flex;align-items:center;gap:0.5rem;padding:0.85rem 1.75rem;border-radius:9999px;font-size:0.925rem;font-weight:600;background:#00ff88;color:#0a0a0a;transition:all 0.3s;text-decoration:none }
      .btn-green:hover { background:#00cc6a;box-shadow:0 0 30px rgba(0,255,136,0.2) }
      ...
      .vp-card:hover { border-color:rgba(0,255,136,0.2);box-shadow:0 0 40px rgba(0,255,136,0.06);transform:translateY(-4px) }

      /* Nav */
      .vp-nav { position:sticky;top:0;z-index:50;padding:1rem 0;background:rgba(10,10,10,0.8);backdrop-filter:blur(20px);border-bottom:1px solid rgba(255,255,255,0.06) }
      ...
      .vp-nav-cta:hover { border-color:#00ff88;color:#00ff88 }
      ...
      .vp-post-link:hover h3 { color:#00ff88 }
  ...
  <body class="antialiased">
    ...
    <nav class="vp-nav">
      <div style="max-width:min(90vw,1200px);margin:0 auto;padding:0 1.5rem;display:flex;align-items:center;justify-content:space-between">
        <a href="/" style="font-weight:700;font-size:1.25rem;color:#fff"><span style="color:#818cf8">v</span>apvarun</a>
      ...
      <section style="padding:clamp(5rem,12vw,10rem) 0;position:relative;overflow:hidden">
        ...
        <div style="max-width:min(90vw,1200px);margin:0 auto;padding:0 1.5rem;position:relative;z-index:1">
          <div class="hero-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:center">
            ...
            <div style="position:relative" class="reveal">
              ...
              <div style="position:relative;border-radius:1rem;overflow:hidden;border:2px solid rgba(255,255,255,0.08);box-shadow:0 25px 50px rgba(0,0,0,0.5)">
                ...
                <div style="position:absolute;bottom:1rem;left:1rem;display:inline-flex;align-items:center;gap:0.5rem;padding:0.4rem 0.75rem;border-radius:9999px;background:rgba(0,0,0,0.6);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,0.08);font-size:0.75rem;color:rgba(255,255,255,0.8)">
                  <span style="width:0.5rem;height:0.5rem;border-radius:50%;background:#00ff88;display:inline-block" class="animate-pulse"></span>
            ...
            {{-- Content --}}
            <div class="reveal">
              <p style="font-size:0.85rem;color:rgba(255,255,255,0.3);font-family:'Space Grotesk',monospace;margin-bottom:1.5rem;letter-spacing:0.15em"><span style="color:#00ff88">$</span> whoami</p>
              ...
              <div style="margin-top:2.5rem;font-family:'Space Grotesk',monospace;font-size:0.85rem;color:rgba(255,255,255,0.3)">
                <p><span style="color:#00ff88">repos:</span> <span style="color:#f5f5f5">125+</span></p>
                <p><span style="color:#00ff88">since:</span> <span style="color:#f5f5f5">2010</span></p>
                <p><span style="color:#00ff88">badges:</span> <span style="color:#f5f5f5">7</span> on WordPress.org</p>
                <p><span style="color:#00ff88">status:</span> <span style="color:#f5f5f5">shipping<span class="vp-cursor">_</span></span></p>
              </div>
            </div>
          </div>
        </div>
