    ...
    <article @php(post_class('group'))>
      <a href="{{ get_permalink() }}" class="flex flex-col md:flex-row gap-6 pb-8 border-b border-[var(--color-surface-tertiary)] last:border-b-0">
        ...
        <div class="flex flex-col justify-center min-w-0">
          ...
          <h2 class="mt-2 text-xl font-bold text-[var(--color-text-primary)] leading-snug group-hover:text-[var(--color-accent)] transition-colors">
            {!! get_the_title() !!}
          </h2>

          <p class="mt-2 text-sm text-[var(--color-text-secondary)] leading-relaxed line-clamp-3">
            {!! get_the_excerpt() !!}
          </p>
