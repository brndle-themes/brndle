...
<article @php(post_class('h-entry'))>
  ...
  <header class="min-h-[60vh] flex items-center justify-center text-center px-6 py-20">
    <div class="max-w-4xl mx-auto">
      ...
      <h1 class="mt-4 text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.05] text-[var(--color-text-primary)] [text-wrap:balance] p-name">
        {!! $title !!}
      </h1>

      <div class="mt-8 flex flex-wrap items-center justify-center gap-4 text-sm text-[var(--color-text-tertiary)]">
