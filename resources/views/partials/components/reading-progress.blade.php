<div id="brndle-progress" class="fixed top-0 left-0 right-0 z-[60] h-0.5 bg-accent origin-left scale-x-0 transition-transform" style="transform-origin: left;"></div>
<script>
