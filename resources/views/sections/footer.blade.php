@php
  ...
  $colsClass = match((int) ($footerColumns ?? 3)) {
    2 => 'lg:grid-cols-2',
    3 => 'lg:grid-cols-3',
...
{{-- ============================================================
     ...
     ============================================================ --}}
@if($style === 'minimal')
<footer class="border-t border-surface-tertiary/50" aria-label="{{ esc_attr__('Site footer', 'brndle') }}">
      ...
      <div>
        <a href="{{ home_url('/') }}" class="flex items-center gap-2.5 mb-4">
          ...
          @else
            ...
            <span class="text-base font-bold text-text-primary">{{ $siteName }}</span>
          @endif
        </a>
        ...
        <div class="flex items-center gap-5">
          @if(!empty($links['twitter']))
            <a href="{{ esc_url($links['twitter']) }}" target="_blank" rel="noopener noreferrer"
               class="text-text-tertiary hover:text-text-primary transition-colors" aria-label="{{ esc_attr__('X / Twitter', 'brndle') }}">
          ...
          @if(!empty($links['github']))
            <a href="{{ esc_url($links['github']) }}" target="_blank" rel="noopener noreferrer"
               class="text-text-tertiary hover:text-text-primary transition-colors" aria-label="{{ esc_attr__('GitHub', 'brndle') }}">
          ...
          @if(!empty($links['linkedin']))
            <a href="{{ esc_url($links['linkedin']) }}" target="_blank" rel="noopener noreferrer"
               class="text-text-tertiary hover:text-text-primary transition-colors" aria-label="{{ esc_attr__('LinkedIn', 'brndle') }}">
          ...
          @if(!empty($links['instagram']))
            <a href="{{ esc_url($links['instagram']) }}" target="_blank" rel="noopener noreferrer"
               class="text-text-tertiary hover:text-text-primary transition-colors" aria-label="{{ esc_attr__('Instagram', 'brndle') }}">
...
{{-- ============================================================
     ...
     ============================================================ --}}
@elseif($style === 'light')
<footer class="bg-surface-secondary text-text-primary" aria-label="{{ esc_attr__('Site footer', 'brndle') }}">
      ...
      <a href="{{ home_url('/') }}" class="flex items-center gap-2.5">
        ...
        @else
          <div class="w-7 h-7 rounded-lg bg-accent flex items-center justify-center">
            <span class="text-on-accent text-xs font-black">{{ mb_substr($siteName, 0, 1) }}</span>
          </div>
  ...
  <div class="bg-accent">
    <div class="max-w-7xl mx-auto px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
      <div class="text-center sm:text-left">
        <h3 class="text-lg font-bold text-on-accent">{{ __('Stay up to date', 'brndle') }}</h3>
        <p class="text-sm text-on-accent/80 mt-1">{{ __('Get the latest news and updates delivered to your inbox.', 'brndle') }}</p>
      </div>
      <form class="flex w-full sm:w-auto gap-2" onsubmit="return false;" aria-label="{{ esc_attr__('Newsletter signup', 'brndle') }}">
        <label for="brndle-footer-email" class="sr-only">{{ __('Email address', 'brndle') }}</label>
        <input id="brndle-footer-email" type="email" placeholder="{{ esc_attr__('Enter your email', 'brndle') }}"
               class="flex-1 sm:w-72 px-4 py-2.5 text-sm rounded-lg bg-on-accent/20 text-on-accent placeholder-on-accent/60 border border-on-accent/20 focus:outline-none focus:ring-2 focus:ring-on-accent/40">
        <button type="submit" class="px-6 py-2.5 text-sm font-semibold rounded-lg bg-on-accent text-accent hover:opacity-90 transition-opacity">
          {{ __('Subscribe', 'brndle') }}
        </button>
      </form>
    </div>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
        ...
        <div class="flex items-center gap-6">
          ...
          <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});return false;"
             class="text-sm text-text-tertiary hover:text-text-primary transition-colors flex items-center gap-1" aria-label="{{ esc_attr__('Back to top', 'brndle') }}">
...
<footer class="bg-surface-primary border-t border-surface-tertiary/50" aria-label="{{ esc_attr__('Site footer', 'brndle') }}">
  <div class="max-w-7xl mx-auto px-6 py-16 flex flex-col items-center text-center gap-6">
    ...
    @if(has_nav_menu('footer_navigation'))
      <nav aria-label="{{ esc_attr__('Footer navigation', 'brndle') }}">
        {!! wp_nav_menu([
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
      ...
      <a href="{{ home_url('/') }}" class="flex items-center gap-2.5">
        ...
        @else
          ...
          <span class="text-sm font-bold text-text-primary">{{ $siteName }}</span>
        @endif
      </a>
