  ...
  <div class="max-w-7xl mx-auto px-6 pt-16 pb-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
      ...
      <div>
        ...
        <p class="text-sm text-white/40 leading-relaxed">{{ get_bloginfo('description', 'display') }}</p>
      </div>
      ...
      @if(has_nav_menu('footer_col_1'))
        <div>
          ...
          {!! wp_nav_menu([
            ...
            'container' => false,
            'echo' => false,
            'link_before' => '<span class="text-sm text-white/40 hover:text-white transition-colors">',
            'link_after' => '</span>',
          ]) !!}
        </div>
      @endif
        ...
        <div class="flex items-center gap-5">
          @if(!empty($links['twitter']))
            <a href="{{ esc_url($links['twitter']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/40 hover:text-white transition-colors" aria-label="X / Twitter">
          ...
          @if(!empty($links['github']))
            <a href="{{ esc_url($links['github']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/40 hover:text-white transition-colors" aria-label="GitHub">
          ...
          @if(!empty($links['linkedin']))
            <a href="{{ esc_url($links['linkedin']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/40 hover:text-white transition-colors" aria-label="LinkedIn">
          ...
          @if(!empty($links['instagram']))
            <a href="{{ esc_url($links['instagram']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/40 hover:text-white transition-colors" aria-label="Instagram">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
        ...
        <div class="flex items-center gap-6">
          ...
          <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});return false;"
             class="text-sm text-white/40 hover:text-white transition-colors flex items-center gap-1" aria-label="Back to top">
