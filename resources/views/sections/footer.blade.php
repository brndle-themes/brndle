        ...
        <div class="flex items-center gap-5">
          @if(!empty($links['twitter']))
            <a href="{{ esc_url($links['twitter']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/60 hover:text-white transition-colors" aria-label="{{ esc_attr__('X / Twitter', 'brndle') }}">
          ...
          @if(!empty($links['github']))
            <a href="{{ esc_url($links['github']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/60 hover:text-white transition-colors" aria-label="{{ esc_attr__('GitHub', 'brndle') }}">
          ...
          @if(!empty($links['linkedin']))
            <a href="{{ esc_url($links['linkedin']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/60 hover:text-white transition-colors" aria-label="{{ esc_attr__('LinkedIn', 'brndle') }}">
          ...
          @if(!empty($links['instagram']))
            <a href="{{ esc_url($links['instagram']) }}" target="_blank" rel="noopener noreferrer"
               class="text-white/60 hover:text-white transition-colors" aria-label="{{ esc_attr__('Instagram', 'brndle') }}">
...
{{-- ============================================================
     ...
     ============================================================ --}}
@elseif($style === 'big')
<footer class="text-white" aria-label="{{ esc_attr__('Site footer', 'brndle') }}">
  {{-- Newsletter section --}}
  <div class="bg-accent">
    <div class="max-w-7xl mx-auto px-6 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
      <div class="text-center sm:text-left">
        <h3 class="text-lg font-bold text-white">{{ __('Stay up to date', 'brndle') }}</h3>
        <p class="text-sm text-white/70 mt-1">{{ __('Get the latest news and updates delivered to your inbox.', 'brndle') }}</p>
      </div>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8">
        ...
        <div class="flex items-center gap-6">
          ...
          <a href="#" onclick="window.scrollTo({top:0,behavior:'smooth'});return false;"
             class="text-sm text-white/60 hover:text-white transition-colors flex items-center gap-1" aria-label="{{ esc_attr__('Back to top', 'brndle') }}">
