@php
  ...
  $headerClasses = match($style) {
    'solid' => 'relative z-50 bg-surface-primary border-b border-surface-tertiary',
    'transparent' => 'fixed top-0 inset-x-0 z-50 bg-transparent',
    default => 'sticky top-0 z-50 bg-surface-primary/80 backdrop-blur-xl border-b border-surface-tertiary/50',
  };
@endphp
...
<header class="{{ $headerClasses }} transition-all">
  <nav class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
    ...
    {{-- Mobile toggle --}}
    <label for="brndle-mobile-menu" class="md:hidden flex items-center justify-center w-10 h-10 cursor-pointer text-text-secondary">
    ...
    {{-- Mobile menu --}}
    <div class="hidden peer-checked:block fixed inset-x-0 top-16 bg-surface-primary border-b border-surface-tertiary shadow-xl z-50 md:hidden">
