...
@section('content')
  <div class="max-w-2xl mx-auto px-6 py-32 text-center">
    ...
    <a href="{{ home_url('/') }}" class="mt-8 inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold rounded-xl bg-text-primary text-white hover:opacity-90 transition-colors">
      {{ __('Go home', 'brndle') }}
    </a>
  </div>
@endsection
